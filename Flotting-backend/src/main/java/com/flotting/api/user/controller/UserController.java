...
public class UserController extends ApiController {
    ...
    public List<UserDetailResponseDto> getDetailUserInfos() {
        List<UserDetailResponseDto> detailUserInfos = userService.getDetailUserInfos();
    ...
    public UserSimpleResponseDto registerSimpleUserInfo(
        ...
        UserSimpleResponseDto userSimpleResponseDto = userService.saveSimpleUserInfo( userSimpleRequestDto);
    ...
    public UserDetailResponseDto registerDetailUserInfo(
        ...
        UserDetailResponseDto userDetailResponseDto = userService.saveDetailUserInfo( targetUserId, userDetailRequestDto);
    ...
    public UserSimpleResponseDto updateSimpleUserInfo(
        ...
        UserSimpleResponseDto userSimpleResponseDto = userService.updateSimpleUserInfo( targetUserId, userSimpleRequestDto);
        return userSimpleResponseDto;
    }
    ...
    public UserDetailResponseDto updateDetailUserInfo(
                                                  @RequestBody UserDetailRequestDto userDetailRequestDto,
                                                  @PathVariable(name = "userId") Long targetUserId) {
        UserDetailResponseDto userDetailResponseDto = userService.updateDetailUserInfo( targetUserId, userDetailRequestDto);
        return userDetailResponseDto;
    }
